...
3. Entre com a conta Microsoft associada ao seu perfil de Microsoft Certification.  Se você não possui um perfil de Microsoft Certification, é preciso criá-lo.
4. Depois de fazer login no seu Perfil de Microsoft Certification, confirme se os detalhes no seu perfil de certificação estão corretos.
...
7. Ao verificar sua conta, você deve se autenticar usando a mesma conta social usada para o registro de eventos (Observação: se você usou uma conta da Microsoft para registro de eventos, deve usar a mesma conta da Microsoft para fazer login no seu perfil de certificação e agendar seu exame. Se isso resultar em dois Perfis de Certificação, entre em contato com [fóruns de suporte da Certificação Microsoft](https://trainingsupport.microsoft.com/en-us/mcp/forum?sort=LastReplyDate&dir=Desc&tab=All&status=all&mod=&modAge=&advFil=&postedAfter=&postedBefore=&threadType=All&isFilterExpanded=false&page=1) para mesclar seus perfis depois de preencher o exame de certificação.)
...
## FAQ - Oferta de Exame Gratuito no MS Ignite e The Tour
...
**R:** Não, você não precisa agendar seu exame gratuito desta oferta durante o evento em que você compareceu. Você pode agendar o exame durante ou após o evento, pois a oferta de exame gratuito expira 180 dias corridos a partir do dia seguinte ao término do evento.
