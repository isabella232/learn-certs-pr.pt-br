...
* Bibliotecas de Referência Eletrônica Microsoft
  ...
  * [Consulte o exemplo de conteúdo da biblioteca de referência eletrônica](https://mseref.safaribooksonline.com/)
...
* Microsoft Imagine Academy (para organizações qualificadas)
  ...
  * Recursos de marketing para promover a associação com a marca Microsoft e certificações oficiais 
  ...
  O programa de educação pronto para a faculdade e a carreira está disponível para todas as instituições acadêmicas credenciadas como uma associação baseada em assinatura. Para participar do [programa Microsoft Imagine Academy](https://www.microsoft.com/pt-br/education/imagine-academy/default.aspx), você deve cumprir certas [normas e requisitos](https://www.microsoft.com/pt-br/education/imagine-academy/become-a-member/default.aspx).

* Pacotes de exames de Certificação Microsoft para instituições acadêmicas
  ...
  | --- | --- | --- |
  | Pacote de site MOS/MTA/MCE | Pacotes de 500 exames que podem ser usados como uma combinação para os exames MOS, MTA e MCE. Os exames MOS validam a compreensão geral e o profundo conhecimento das habilidades do Office necessárias para as empresas, diferenciando os alunos e melhorando suas chances de sucesso à medida que avançam no ensino superior ou ingressam na força de trabalho. Os exames MTA validam os principais conceitos de tecnologia em infraestrutura, banco de dados e desenvolvimento, ajudando os alunos a se prepararem para a educação tecnológica e/ou certificações mais avançadas. A certificação MTA pode ser obtida em um semestre e pode ser usada para demonstrar capacidade e compromisso para cargos de TI de nível inicial. O programa Microsoft Certified Educator (MCE) fornece ferramentas robustas que ajudam os educadores a promover a melhor integração da classe da tecnologia da informação e comunicação (TIC) nas instruções em sala de aula. Mapeado para o Quadro de Competências TIC da UNESCO para Educadores. | 500 |
  | Pacote de site MTA/MCE e MOS/MCE | Pacotes de 125 exames que podem ser usados em conjunto com os exames MTA/MCE e MOS/MCE. Os exames MOS validam a compreensão geral e o profundo conhecimento das habilidades do Office necessárias para as empresas, diferenciando os alunos e melhorando suas chances de sucesso à medida que avançam no ensino superior ou ingressam na força de trabalho. Os exames MTA validam os principais conceitos de tecnologia em infraestrutura, banco de dados e desenvolvimento, ajudando os alunos a se prepararem para a educação tecnológica e/ou certificações mais avançadas. A certificação MTA pode ser obtida em um semestre e pode ser usada para demonstrar capacidade e compromisso para cargos de TI de nível inicial. O programa Microsoft Certified Educator (MCE) fornece ferramentas robustas que ajudam os educadores a promover a melhor integração da classe da tecnologia da informação e comunicação (TIC) nas instruções em sala de aula. Mapeado para o Quadro de Competências TIC da UNESCO para Educadores. | 125 |
  | Pacote de Aulas Microsoft Certified Professional (MCP) | Os voucher de exame MCP podem ser usados para obter as certificações Microsoft Certified Solutions Associate (MCSA), Microsoft Certified Solutions Expert (MCSE) ou Microsoft Certified Solutions Developer (MCSD). Estas certificações validam as habilidades que são cruciais para as carreiras atuais em TI. As certificações MCSA validam as principais habilidades na plataforma e as certificações MCSD e MCSE validam o profundo conhecimento necessário para projetar, criar e implementar soluções. | 30 |

  Você pode solicitar sua associação anual ao Microsoft Imagine Academy e os pacotes de exames de Certificação Microsoft através dos seguintes programas de Licenciamento por Volume Microsoft Academic:

  * Inscrição para Soluções Educacionais (EES)
  * Inscrição na escola (sob um Contrato Campus e Escola)
  * Selecione Plus para Academic

  Para obter mais informações, entre em contato com o seu Revendedor de Licenciamento Acadêmico ou visite a página [programas de Licenciamento da Microsoft para indústrias](https://www.microsoft.com/licensing/licensing-options/for-industries.aspx).

  **Recursos adicionais de certificação acadêmica  de Licenciamento por Volume**

  * [Guia de Benefícios do Programa Microsoft Imagine Academy](https://download.microsoft.com/download/C/6/1/C616A2EB-0245-48AC-9ECA-BBEBB1B781C6/Imagine_Academy_FactSheet.pdf)
  * [ficha de dados da Certificação Microsoft para Instituições Acadêmicas](https://download.microsoft.com/download/B/6/7/B6783ECC-2C82-4C76-AF39-52709D54D0F3/IT_Academy-Cert_Datasheet.pdf)
  * [Roteiro de Certificação do Microsoft Imagine Academy](https://download.microsoft.com/download/C/6/1/C616A2EB-0245-48AC-9ECA-BBEBB1B781C6/Certification_Roadmap_A1_ENU.pdf)
  * [ficha de dados do pacote de exame de Certificação Microsoft para Licenciamento por Volume Acadêmico](https://download.microsoft.com/download/B/6/7/B6783ECC-2C82-4C76-AF39-52709D54D0F3/ITA-Cert_VLflyer_Customer.pdf)
...
* Recursos de e-learning adicionais de Licenciamento por Volume
  ...
  * [Demonstração de Ativação de E-Learning](https://www.microsoft.com/learning/_silverlight/vl/vl.htm)
  * [Guia do Centro de Administração de Empresas para Uso Online](https://www.microsoft.com/learning/_silverlight/bac/bac.htm)
  ...
  * [Certificação Microsoft para instituições acadêmicas](https://download.microsoft.com/download/B/6/7/B6783ECC-2C82-4C76-AF39-52709D54D0F3/IT_Academy-Cert_Datasheet.pdf)
  * [Roteiro de Certificação do Microsoft Imagine Academy](https://download.microsoft.com/download/C/6/1/C616A2EB-0245-48AC-9ECA-BBEBB1B781C6/Certification_Roadmap_A1_ENU.pdf)
  * [Pacote de exame de Certificação Microsoft para Licenciamento por Volume Acadêmico](https://download.microsoft.com/download/B/6/7/B6783ECC-2C82-4C76-AF39-52709D54D0F3/ITA-Cert_VLflyer_Customer.pdf)
...
**Observação** Se você solicitar soluções de treinamento e certificação da Microsoft como uma assinatura de 12 meses, os pedidos subsequentes expirarão na mesma data que o pedido de assinatura inicial de 12 meses. [Visite o Guia de Serviços Online](https://www.microsoft.com/learning/_silverlight/bac/bac.htm).
...
Se você estiver  realizando exames de certificação de TI da Microsoft e MCP Site Pack, visite o site da Pearson VUE para saber como sua instituição pode se tornar um [centro de testes da Pearson VUE](https://www.pearsonvue.com/microsoft).  Os exames de certificação MOS e MTA são fornecidos pela Certiport.
