...
## <a name="take-a-system-test"></a> Faça um teste do sistema

Faça um teste do sistema agora para verificar se seu computador e localização são compatíveis com o software de supervisão online antes de agendar seu exame.
...
**ALERTA! Antes de se inscrever para um exame on-line:**
...
2. **Verifique se seu documento de identificação é válido (consulte os [requisitos](https://home.pearsonvue.com/Policies/1S/English)) e se o nome no seu perfil de Certificação Microsoft corresponde exatamente ao nome na identificação que você deseja usar para realizar o exame.**  
3. **Reveja os requisitos técnicos, do sistema, do ambiente e do protocolo de teste abaixo.**
...
- O nome no documento de identificação deverá ser o mesmo do perfil da Certificação Microsoft e da Pearson VUE.
...
### Sem pausas/para comer/para beber
...
## Registre-se para um exame on-line
...
- Para se registrar, selecione o exame da Microsoft que você deseja fazer na [lista de exames](/learn/certifications/browse/), e selecione o botão **Agendar exame**. Se exames online estiverem disponíveis no seu país, você poderá selecionar essa opção durante o processo de registro do exame. Você também deverá selecionar o idioma do anfitrião, supervisor e do software de supervisão.
...
- Certifique-se de manter seu telefone celular próximo de você, com a tela visível, caso o supervisor precise entrar em contato com você.
- Desative os bloqueadores de pop-up do navegador.
- Verifique se você possui direitos administrativos no seu computador para fazer o download do software de teste.
...
Se você não se conectar a um supervisor 30 minutos **após o horário agendado para o exame**, entre em contato com a [Pearson VUE](https://home.pearsonvue.com/contact).
...
Para se registrar, selecione o exame que você deseja fazer na [lista de exames](/learn/certifications/browse/), e selecione o botão **Agendar exame**. Se exames online estiverem disponíveis no seu país, você poderá selecionar essa opção durante o processo de registro do exame.
